...
const SocialsBlock = () => (
  <>
    ...
    >
      <a
        href="https://www.linkedin.com/in/kush-garg9/"
    ...
    <Block
      ...
      className="col-span-6 bg-purple-900 md:col-span-3"
    >
      <a
        href="https://github.com/kush0904"
        className="grid h-full place-content-center text-3xl text-white"
        target="_blank"
      >
        <SiGithub />
    ...
    >
      <a
        href="mailto:kush904garg2@gmail.com"
        className="grid h-full place-content-center text-3xl text-white"
        target="_blank"
      >
        <SiGmail />
    ...
    <Block
      ...
      className="col-span-6 bg-rose-900	 md:col-span-3"
    >
      <a
        href="#"
        className="grid h-full place-content-center text-3xl text-white"
